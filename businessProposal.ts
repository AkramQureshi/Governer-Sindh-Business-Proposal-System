...
export async function exportbusinessProposal() 
 {
...
if(businessProposal.currentStatus == "Business" && businessProposal.businessExp == "Yes" && businessProposal.businessType == "Land/Property" && businessProposal.spaceToRun == "Yes" && businessProposal.cnic == "42201-1234567-8")
    {
